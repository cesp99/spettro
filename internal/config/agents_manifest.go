...
func DefaultAgentManifest() AgentManifest {
	m := AgentManifest{
		...
		Agents: []AgentSpec{
			{ID: "plan", Name: "Plan", Description: "Planning orchestrator", Skill: "planning", Mode: "orchestrator", Role: AgentRoleOrchestrator, Color: "blue", AllowedTools: []string{"agent", "glob", "grep", "file-read", "tool-search", "task-create", "task-get", "task-update", "task-list", "task-stop", "config", "ask-user", "enter-plan-mode", "exit-plan-mode", "send-message", "todo-write", "comment"}, PermittedActions: []string{"read", "search", "plan", "write"}, Permission: PermissionAskFirst, MaxSteps: 30, Enabled: true, Handoffs: []string{"explore", "review", "docs"}, PromptFile: "agents/planning.md"},
			{ID: "coding", Name: "Coding", Description: "Coding orchestrator", Skill: "implementation", Mode: "orchestrator", Role: AgentRolePrimary, Color: "green", AllowedTools: []string{"agent", "glob", "grep", "file-read", "tool-search", "task-create", "task-get", "task-update", "task-list", "task-stop", "config", "send-message", "todo-write", "comment"}, PermittedActions: []string{"read", "search", "plan", "write"}, Permission: PermissionRestricted, MaxSteps: 32, Enabled: true, Handoffs: []string{"code", "git", "test", "review", "docs", "explore"}, PromptFile: "agents/coding.md"},
			{ID: "ask", Name: "Ask", Description: "Read-only orchestrator for Q&A", Skill: "conversation", Mode: "orchestrator", Role: AgentRolePrimary, Color: "cyan", AllowedTools: []string{"agent", "glob", "grep", "file-read", "tool-search", "web-search", "mcp-list-resources", "mcp-read-resource", "comment"}, PermittedActions: []string{"ask", "read", "search"}, Permission: PermissionAskFirst, MaxSteps: 16, Enabled: true, Handoffs: []string{"explore", "docs"}, PromptFile: "agents/chat.md"},
